...
def main() -> int:
    ...
    required_tokens = {
        ...
        "diagram blueprint marker": 'data-learning-flow-blueprint="true"',
        "diagram canvas marker": 'data-learning-flow-canvas="true"',
        "diagram node marker": 'data-learning-flow-node="true"',
        "diagram node index marker": 'data-learning-flow-node-index="true"',
        "diagram node accent marker": 'data-learning-flow-node-accent="true"',
        "diagram connector marker": 'data-learning-flow-connector="true"',
        "diagram runtime marker": 'data-learning-flow-runtime="true"',
        "diagram runtime node marker": 'data-learning-flow-runtime-node="true"',
        ...
        "diagram runtime resolver": "function diagramRuntimeNodes",
        "diagram runtime source": "diagram.runtime",
        "diagram runtime fallback source": "diagram.runtimeLayer",
