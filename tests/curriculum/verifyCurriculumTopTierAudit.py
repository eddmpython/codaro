...
def buildDomains(summary: dict[str, Any], lessons: list[dict[str, Any]]) -> list[dict[str, Any]]:
    return [
        ...
        domain("structured-source-contract-adoption", (
            ...
            textContains("matrix verifies structured samples", "tests/curriculum/verifyCurriculumQualityMatrix.py", "REQUIRED_SECTION_FLOW"),
            textContains("browser verifies structured cards", "tests/learning/verifyLearningCardPlaywright.py", "data-learning-section-structured"),
        )),
