...
OBJECTIVE_REQUIREMENTS = (
    ...
    ObjectiveRequirement(
        requirementId="objective-nineplus-scorecard",
        requirement="The current 9+ target is judged by an objective multi-domain scorecard with external reference criteria and current artifact evidence.",
        evidenceChecks=(
            ...
            ("tests/verifyObjectiveNinePlusScorecard.py", (
                "objective-nineplus-report.json",
                "PRODUCT_QUALITY_GATES",
            ...
            ("tests/run.py", (
                ...
                "tests/verifyObjectiveNinePlusScorecard.py",
                "\"automation-ide-audit\"",
                "output/test-runner/objective-nineplus-audit/objective-nineplus-report.json",
            )),
            ("docs/skills/ops/foundation/testing-and-gates.md", (
                "`objective-nineplus-audit`",
                "ISO/IEC 25010",
