...
def readinessCriteria(liveChecks: dict[str, LiveGateCheck]) -> tuple[ReadinessCriterion, ...]:
    ...
    return (
        ...
        fileCriterion(
            ...
            "Lesson overview direction, benefit, and concrete workflow diagram are verified in desktop and mobile browser rendering.",
            (
                ("editor/src/components/curriculum/curriculumSurface.tsx", (
