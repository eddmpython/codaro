...
- id: workflow_validation
  ...
  goal: 영수증과 로그 문자열을 조립한 뒤 빠진 조각이 없는지 assert로 검증하는 흐름을 확인한다.
  ...
  exercise:
    prompt: |-
      ...
      assert 세 줄이 모두 통과하고 마지막에 [INFO] order_created: ORD-2026-0007 이 나와야 합니다.
    starterCode: |-
      level = 'INFO'
    ...
    solution: |-
      ...
      logLine
    hints:
    - 값을 바꾸면 assert가 AssertionError로 멈춥니다. 그때는 원래 값으로 되돌리세요.
    - "정답 형태: 코드를 그대로 실행, 마지막 값 [INFO] order_created: ORD-2026-0007"
  check:
    type: outputExact
    evidence: practice
    outputExact: '[INFO] order_created: ORD-2026-0007'
    resultCheck: "출력이 정확히 일치해야 합니다: '[INFO] order_created: ORD-2026-0007'"
- id: practice
  title: Day 4 종합 복습
  structuredPrimary: true
