...
assessment:
  ...
  - id: pillow_00-pillow_runtime-result-reconciliation-transfer
    ...
    goal: Pillow 이미지 artifact 결과의 sourceHash, format identity와 decodedPixels metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: pillow_00-pillow_runtime-evidence-recall-retrieval
    ...
    goal: Pillow 이미지 artifact의 source, edit, artifact 단계별 action, evidence, risk를 기억에서 복원한다.
