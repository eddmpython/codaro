...
assessment:
  ...
  - id: pillow_04-photo_filter-result-reconciliation-transfer
    ...
    goal: 사진 필터 스튜디오 결과의 sourceHash, filterId identity와 edgeEnergy metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: pillow_04-photo_filter-evidence-recall-retrieval
    ...
    goal: 사진 필터 스튜디오의 source, edit, artifact 단계별 action, evidence, risk를 기억에서 복원한다.
