...
assessment:
  ...
  - id: visionFeatures_06-video_io-result-reconciliation-transfer
    ...
    goal: 비디오 입출력 결과의 videoHash, codec identity와 writtenFrames metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_06-video_io-evidence-recall-retrieval
    ...
    goal: 비디오 입출력의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
