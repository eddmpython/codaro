...
assessment:
  ...
  - id: deepVision_09-model_comparison-result-reconciliation-transfer
    ...
    goal: 모델 비교 결과의 datasetHash, benchmarkHash identity와 bestScore metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_09-model_comparison-evidence-recall-retrieval
    ...
    goal: 모델 비교의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
