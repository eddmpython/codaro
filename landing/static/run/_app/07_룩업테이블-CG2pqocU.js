...
assessment:
  ...
  - id: visionBasics_07-lookup_table-result-reconciliation-transfer
    ...
    goal: 룩업 테이블 결과의 sourceHash, lutHash identity와 distinctOutputCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionBasics_07-lookup_table-evidence-recall-retrieval
    ...
    goal: 룩업 테이블의 input, process, result 단계별 action, evidence, risk를 기억에서 복원한다.
