...
assessment:
  ...
  - id: visionBasics_01-pixel_array-result-reconciliation-transfer
    ...
    goal: 픽셀과 ndarray 결과의 sourceHash, colorOrder identity와 pixelCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionBasics_01-pixel_array-evidence-recall-retrieval
    ...
    goal: 픽셀과 ndarray의 input, process, result 단계별 action, evidence, risk를 기억에서 복원한다.
