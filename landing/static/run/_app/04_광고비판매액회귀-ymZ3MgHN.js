...
assessment:
  ...
  - id: seaborn_04-advertising-regression-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 교육 시간과 평가 점수의 관측 관계를 cohort별 회귀와 interval로 탐색한다.'
  ...
  - id: seaborn_04-advertising-regression-interpretation-retrieval-retrieval
    ...
    goal: 회귀선이 인과 효과가 아니라 관측 관계임을 드러내는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
