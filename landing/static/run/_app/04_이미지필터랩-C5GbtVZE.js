...
assessment:
  ...
  - id: opencv_04-opencv_filter-result-reconciliation-transfer
    ...
    goal: 이미지 필터 랩 결과의 sourceHash, filterHash identity와 noiseStd metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: opencv_04-opencv_filter-evidence-recall-retrieval
    ...
    goal: 이미지 필터 랩의 source, operation, result 단계별 action, evidence, risk를 기억에서 복원한다.
