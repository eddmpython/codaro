...
assessment:
  ...
  - id: opencv_09-contour-result-reconciliation-transfer
    ...
    goal: 컨투어 탐지기 결과의 sourceHash, contourConfig identity와 acceptedContours metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: opencv_09-contour-evidence-recall-retrieval
    ...
    goal: 컨투어 탐지기의 source, operation, result 단계별 action, evidence, risk를 기억에서 복원한다.
