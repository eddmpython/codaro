...
assessment:
  ...
  - id: visionApps_08-video_thumbnail-result-reconciliation-transfer
    ...
    goal: 영상 자동 썸네일 결과의 videoHash, samplingPlanHash identity와 selectedTimestamp metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionApps_08-video_thumbnail-evidence-recall-retrieval
    ...
    goal: 영상 자동 썸네일의 admission, process, release 단계별 action, evidence, risk를 기억에서 복원한다.
