...
assessment:
  ...
  - id: seaborn_02-tip-distribution-semantics-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 응답 시간 분포를 트래픽 유형별 동일 bin으로 비교한다.'
  ...
  - id: seaborn_02-tip-distribution-semantics-interpretation-retrieval-retrieval
    ...
    goal: histogram과 KDE의 가정과 분모를 분리했는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
