...
assessment:
  ...
  - id: visionFeatures_01-corner_detection-result-reconciliation-transfer
    ...
    goal: 코너 검출 결과의 sourceHash, detectorHash identity와 cornerCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_01-corner_detection-evidence-recall-retrieval
    ...
    goal: 코너 검출의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
