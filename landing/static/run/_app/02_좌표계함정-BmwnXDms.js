...
assessment:
  ...
  - id: visionBasics_02-image_coordinates-result-reconciliation-transfer
    ...
    goal: 이미지 좌표계 결과의 sourceHash, origin identity와 sampleValue metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionBasics_02-image_coordinates-evidence-recall-retrieval
    ...
    goal: 이미지 좌표계의 input, process, result 단계별 action, evidence, risk를 기억에서 복원한다.
