...
- id: dict_intro
  ...
  goal: 딕셔너리에서 키 하나에 연결된 값을 바꾸고 전체가 어떻게 표시되는지 확인한다.
  why: 이름, 종류, 연도처럼 항목마다 뜻이 다른 데이터는 리스트의 0번, 1번보다 딕셔너리의 키 이름으로 다루는 편이 훨씬 덜 헷갈립니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      lang에서 'type'의 값 'Language'를 'Programming Language'로 바꾸세요.

      실행하면 {'name': 'Python', 'type': 'Programming Language', 'year': 1991}이 나와야 합니다.
    starterCode: |-
      lang = {'name': 'Python', 'type': 'Language', 'year': 1991}
      lang
    solution: |-
      lang = {'name': 'Python', 'type': 'Programming Language', 'year': 1991}
      lang
    hints:
    - "'type': 'Language' 에서 값 부분만 'Programming Language' 로 바꿉니다. 키 이름 'type'과 나머지 두 항목은 그대로 둡니다."
    - "정답 형태: 'type': 'Programming Language'"
  check:
    type: outputExact
    evidence: practice
    outputExact: "{'name': 'Python', 'type': 'Programming Language', 'year': 1991}"
    resultCheck: "출력이 정확히 일치해야 합니다: \\"{'name': 'Python', 'type': 'Programming Language', 'year': 1991}\\""
- id: dict_create
  title: 딕셔너리 생성하기
  structuredPrimary: true
  subtitle: 다양한 방법으로 만들기
  goal: 중괄호 대신 dict() 함수로 같은 형태의 딕셔너리를 만든다.
  why: 다른 사람의 코드나 라이브러리 문서에서 dict(name=..., age=...) 형태가 자주 나오는데, 중괄호로 만든 것과 결과가 같다는 것을 알아야 읽을 수 있습니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      person을 중괄호 대신 dict() 함수로 만들고, city 값만 '대전'으로 바꾸세요. dict() 안에서는 키를 따옴표 없이 이름 인자로 씁니다.

      실행하면 {'name': '홍길동', 'age': 25, 'city': '대전'}이 나와야 합니다. 중괄호로 만든 것과 표시 형태가 똑같습니다.
    starterCode: |-
      person = {'name': '홍길동', 'age': 25, 'city': '서울'}
      person
    solution: |-
      person = dict(name='홍길동', age=25, city='대전')
      person
    hints:
    - "person = {'name': '홍길동', 'age': 25, 'city': '서울'} 를 person = dict(name='홍길동', age=25, city='대전') 으로 바꿉니다. 마지막 줄 person은 그대로 둡니다."
    - "정답 형태: person = dict(name='홍길동', age=25, city='대전')"
  check:
    type: outputExact
    evidence: practice
    outputExact: "{'name': '홍길동', 'age': 25, 'city': '대전'}"
    resultCheck: "출력이 정확히 일치해야 합니다: \\"{'name': '홍길동', 'age': 25, 'city': '대전'}\\""
- id: dict_access
  title: 키로 값 접근하기
  structuredPrimary: true
  subtitle: 대괄호 [] 사용
  goal: 대괄호 안의 키를 바꿔 딕셔너리에서 다른 값을 꺼낸다.
  why: 딕셔너리는 몇 번째인지가 아니라 키 이름으로 값을 꺼내기 때문에, 항목 순서를 몰라도 필요한 값만 정확히 집을 수 있습니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      마지막 줄 dev['name']을 dev['job']으로 바꾸세요.

      실행하면 developer가 나와야 합니다.
    starterCode: |-
      dev = {'name': '김철수', 'age': 30, 'job': 'developer'}
      dev['name']
    solution: |-
      ...
      dev['job']
    hints:
    - "dev['name'] 을 dev['job'] 으로 바꿉니다. 첫 줄 딕셔너리는 그대로 둡니다."
    - "정답 형태: dev['job']"
  check:
    type: outputExact
    evidence: practice
    outputExact: developer
    resultCheck: "출력이 정확히 일치해야 합니다: 'developer'"
- id: dict_modify
  title: 키로 값 수정하기
  structuredPrimary: true
  subtitle: 기존 값 변경
  goal: 어느 키에 값을 넣느냐에 따라 딕셔너리의 어떤 항목이 바뀌는지 확인한다.
  why: 재고나 가격을 갱신할 때 키 하나만 지정하면 나머지 항목은 건드리지 않고 그대로 남습니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      가운데 줄 laptop['price'] = 1200000을 laptop['stock'] = 3으로 바꾸세요.

      price는 1000000 그대로 남고 stock만 바뀌어 {'name': '노트북', 'price': 1000000, 'stock': 3}이 나와야 합니다.
    starterCode: |-
      laptop = {'name': '노트북', 'price': 1000000, 'stock': 5}
      laptop['price'] = 1200000
      laptop
    solution: |-
      ...
      laptop
    hints:
    - "laptop['price'] = 1200000 을 laptop['stock'] = 3 으로 바꿉니다. 첫 줄과 마지막 줄은 그대로 둡니다."
    - "정답 형태: laptop['stock'] = 3"
  check:
    type: outputExact
    evidence: practice
    outputExact: "{'name': '노트북', 'price': 1000000, 'stock': 3}"
    resultCheck: "출력이 정확히 일치해야 합니다: \\"{'name': '노트북', 'price': 1000000, 'stock': 3}\\""
- id: dict_add
  title: 새 키-값 쌍 추가하기
  structuredPrimary: true
  subtitle: 없는 키에 값 할당
  goal: 딕셔너리에 없던 키에 값을 넣어 항목을 하나 더 붙인다.
  why: 계산한 합계나 처리 상태처럼 나중에 정해지는 값을 기존 데이터에 덧붙일 때 별도 메서드 없이 이 한 줄이면 됩니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      가운데 줄 member['city'] = '부산'을 member['job'] = 'designer'로 바꾸세요.

      없던 키는 맨 뒤에 붙으므로 {'name': '이영희', 'age': 28, 'job': 'designer'}가 나와야 합니다.
    starterCode: |-
      member = {'name': '이영희', 'age': 28}
      member['city'] = '부산'
      member
    solution: |-
      ...
      member
    hints:
    - "member['city'] = '부산' 을 member['job'] = 'designer' 로 바꿉니다. 첫 줄과 마지막 줄은 그대로 둡니다."
    - "정답 형태: member['job'] = 'designer'"
  check:
    type: outputExact
    evidence: practice
    outputExact: "{'name': '이영희', 'age': 28, 'job': 'designer'}"
    resultCheck: "출력이 정확히 일치해야 합니다: \\"{'name': '이영희', 'age': 28, 'job': 'designer'}\\""
- id: dict_delete
  title: del로 키-값 삭제
  structuredPrimary: true
  subtitle: 항목 제거하기
  goal: del 뒤의 키를 바꿔 원하는 항목만 딕셔너리에서 없앤다.
  why: 응답 데이터에서 더 필요 없거나 밖으로 내보내면 안 되는 항목을 키와 값째로 걷어낼 때 씁니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      가운데 줄 del alpha['b']를 del alpha['d']로 바꾸세요.

      d 항목만 사라져 {'a': 1, 'b': 2, 'c': 3}이 나와야 합니다.
    starterCode: |-
      alpha = {'a': 1, 'b': 2, 'c': 3, 'd': 4}
      del alpha['b']
      alpha
    solution: |-
      ...
      alpha
    hints:
    - "del alpha['b'] 를 del alpha['d'] 로 바꿉니다. 첫 줄과 마지막 줄은 그대로 둡니다."
    - "정답 형태: del alpha['d']"
  check:
    type: outputExact
    evidence: practice
    outputExact: "{'a': 1, 'b': 2, 'c': 3}"
    resultCheck: "출력이 정확히 일치해야 합니다: \\"{'a': 1, 'b': 2, 'c': 3}\\""
- id: dict_membership
  title: in/not in 연산자
  structuredPrimary: true
  subtitle: 키 존재 확인
  goal: in이 값이 아니라 키만 확인한다는 것을 결과가 False로 뒤집히는 것으로 확인한다.
  why: 값을 넣고 in으로 검사하면 항상 없다고 나오기 때문에, in이 무엇을 보는지 모르면 조건문이 에러 없이 조용히 틀립니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      마지막 줄에서 찾는 대상 'math'를 따옴표 없는 85로 바꾸세요.

      85는 math의 값이지 키가 아니고 in은 키만 확인하므로, 지금은 True지만 바꾸면 False가 나와야 합니다.
    starterCode: |-
      grades = {'math': 85, 'english': 90, 'science': 88}
      'math' in grades
    solution: |-
      ...
      85 in grades
    hints:
    - "'math' in grades 를 85 in grades 로 바꿉니다. 85에는 따옴표를 붙이지 않고, 첫 줄 딕셔너리는 그대로 둡니다."
    - "정답 형태: 85 in grades"
  check:
    type: outputExact
    evidence: practice
...
- id: dict_length
  ...
  structuredPrimary: true
  subtitle: len() 함수
  goal: 딕셔너리에서 항목 하나를 지우고 len()이 세는 개수가 줄어드는 것을 확인한다.
  why: 넘겨받은 데이터에 필요한 항목이 다 들어왔는지 개수로 먼저 세어 보면 빠진 필드를 일찍 발견합니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      profile에서 마지막 항목 'job': 'teacher'를 지워 세 항목만 남기세요.
    ...
    starterCode: |-
      ...
      len(profile)
    solution: |-
      profile = {'name': '박민수', 'age': 35, 'city': '대구'}
      len(profile)
    hints:
    - "중괄호 끝의 , 'job': 'teacher' 부분을 지웁니다. 마지막 줄 len(profile)은 그대로 둡니다."
    - "정답 형태: profile = {'name': '박민수', 'age': 35, 'city': '대구'}"
  check:
    type: outputExact
    evidence: practice
    outputExact: '3'
...
- id: dict_multiple
  ...
  goal: 큰 딕셔너리에서 필요한 키만 골라 작은 딕셔너리를 새로 만든다.
  why: 사용자 정보 전체 중 화면에 보여줄 항목만 추려 넘길 때, 원본을 건드리지 않고 필요한 필드만 담은 새 딕셔너리를 만들게 됩니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      가운데 줄에서 'age': full['age'] 부분을 'job': full['job']으로 바꾸세요.

      basic에 이름과 직업만 담겨 {'name': '정지은', 'job': 'engineer'}가 나와야 합니다.
    starterCode: |-
      full = {'name': '정지은', 'age': 27, 'city': '인천', 'job': 'engineer', 'hobby': 'reading'}
      basic = {'name': full['name'], 'age': full['age']}
      basic
    solution: |-
      full = {'name': '정지은', 'age': 27, 'city': '인천', 'job': 'engineer', 'hobby': 'reading'}
      basic = {'name': full['name'], 'job': full['job']}
      basic
    hints:
    - "새 딕셔너리의 키와 꺼내는 키를 함께 바꿉니다. 'age': full['age'] 를 'job': full['job'] 으로 씁니다. 첫 줄과 마지막 줄은 그대로 둡니다."
    - "정답 형태: basic = {'name': full['name'], 'job': full['job']}"
  check:
    type: outputExact
    evidence: practice
    outputExact: "{'name': '정지은', 'job': 'engineer'}"
    resultCheck: "출력이 정확히 일치해야 합니다: \\"{'name': '정지은', 'job': 'engineer'}\\""
- id: dict_nested
  title: 중첩 딕셔너리
  structuredPrimary: true
  subtitle: 딕셔너리 안의 딕셔너리
  goal: 대괄호를 두 번 이어 붙여 딕셔너리 안쪽 딕셔너리의 값까지 꺼낸다.
  why: JSON 설정 파일이나 서버 응답은 대부분 딕셔너리 안에 딕셔너리라서, 안쪽 값을 꺼내려면 이 표기가 반드시 필요합니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      마지막 줄 team['user1']을 team['user2']['name']으로 바꾸세요.

      user2 안쪽의 name까지 꺼내므로 이디자인이 나와야 합니다.
    starterCode: |-
      team = {
          'user1': {'name': '김개발', 'age': 28},
          'user2': {'name': '이디자인', 'age': 25}
    ...
    solution: |-
      ...
      team['user2']['name']
    hints:
    - "team['user1'] 을 team['user2']['name'] 으로 바꿉니다. 바깥 키를 먼저 쓰고 대괄호를 한 번 더 이어서 안쪽 키를 씁니다."
    - "정답 형태: team['user2']['name']"
  check:
    type: outputExact
    evidence: practice
    outputExact: 이디자인
    resultCheck: "출력이 정확히 일치해야 합니다: '이디자인'"
- id: dict_keys_types
  title: 다양한 키 타입
  structuredPrimary: true
  subtitle: 문자열, 숫자, 튜플
  goal: list는 키가 될 수 없고 frozenset은 될 수 있다는 것을 실제 에러 메시지로 확인한다.
  why: 키로 못 쓰는 타입을 넣으면 TypeError로 프로그램이 그 자리에서 멈추기 때문에, 무엇이 키가 되는지 손으로 한 번 확인해 두어야 합니다.
  explanation: |-
  ...
  exercise:
    prompt: |-
      'frozenset ___' 안의 빈칸 ___을 ok로 바꿔 'frozenset ok'가 되게 하세요. 나머지 줄은 그대로 둡니다.

      list 키는 try/except에 걸려 에러 메시지가 담기고, frozenset 키는 정상 저장되어 아래 한 줄이 나와야 합니다.
      {'listMessage': "unhashable type: 'list'", 'frozensetValue': 'frozenset ok'}
    starterCode: |-
      keyTestDict = {}
      try:
    ...
    solution: |-
      ...
      keyTestDict[frozenset({1, 2})] = 'frozenset ok'
    ...
    hints:
    - "keyTestDict[frozenset({1, 2})] = 'frozenset ___' 줄에서 ___ 세 글자만 ok로 바꿉니다. try/except 줄과 마지막 딕셔너리는 그대로 둡니다."
    - "정답 형태: keyTestDict[frozenset({1, 2})] = 'frozenset ok'"
    check:
  ...
  check:
    ...
    outputExact: |-
      {'listMessage': "unhashable type: 'list'", 'frozensetValue': 'frozenset ok'}
    resultCheck: |-
      출력이 정확히 일치해야 합니다: {'listMessage': "unhashable type: 'list'", 'frozensetValue': 'frozenset ok'}
- id: workflow_validation
  title: '검증 루프: 주문 레코드 만들고 필수 필드 확인'
  structuredPrimary: true
  subtitle: 딕셔너리를 업무 데이터의 작은 레코드로 사용하기
  goal: 튜플 키로 만든 표에서 값을 찾고, 찾은 값과 없는 키를 assert로 못박아 확인한다.
  why: 좌표나 코드번호로 찾는 표는 키가 하나만 어긋나도 조용히 다른 값을 돌려주기 때문에, 기준값을 assert로 코드에 박아 두어야 합니다.
  ...
  exercise:
    prompt: |-
      ...
      assert 두 줄이 모두 통과하고 마지막에 서울점이 나와야 합니다.
    starterCode: |-
      storesByCoord = {
          (37, 127): '서울점',
          (35, 129): '부산점'
    ...
    solution: |-
      ...
      storeName
    hints:
    - 좌표 숫자나 지점 이름을 바꾸면 assert가 AssertionError로 멈춥니다. 그때는 원래 값으로 되돌리세요.
    - "정답 형태: 코드를 그대로 실행, 마지막 값 서울점"
  check:
    type: outputExact
    evidence: practice
    outputExact: 서울점
    resultCheck: "출력이 정확히 일치해야 합니다: '서울점'"
- id: practice
  title: Day 11 종합 복습
  structuredPrimary: true
  subtitle: 딕셔너리 기초 마스터하기
  goal: 오늘 배운 대괄호 추가로 딕셔너리에 항목 하나를 직접 붙여 본다.
  why: 딕셔너리를 만들고 항목을 더하는 두 동작을 손으로 한 번 더 해 봐야 다음 강의의 딕셔너리 메서드를 바로 쓸 수 있습니다.
  ...
  exercise:
    prompt: |-
      첫 줄과 마지막 줄 사이에 info['type'] = 'Language' 한 줄을 추가하세요.

      없던 키는 맨 뒤에 붙으므로 {'name': 'Python', 'year': 1991, 'type': 'Language'}가 나와야 합니다.
    starterCode: |-
      info = {'name': 'Python', 'year': 1991}
      info
    solution: |-
      ...
      info
    hints:
    - "info = {'name': 'Python', 'year': 1991} 다음 줄에 info['type'] = 'Language' 를 넣습니다. 마지막 줄 info는 그대로 둡니다."
    - "정답 형태: info['type'] = 'Language'"
  check:
    type: outputExact
    evidence: practice
    outputExact: "{'name': 'Python', 'year': 1991, 'type': 'Language'}"
    resultCheck: "출력이 정확히 일치해야 합니다: \\"{'name': 'Python', 'year': 1991, 'type': 'Language'}\\""
assessment:
  schemaVersion: 1
