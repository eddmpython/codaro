...
assessment:
  ...
  - id: visionFeatures_03-feature_matching-result-reconciliation-transfer
    ...
    goal: 특징점 매칭 결과의 queryHash, trainHash identity와 inlierRatio metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_03-feature_matching-evidence-recall-retrieval
    ...
    goal: 특징점 매칭의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
