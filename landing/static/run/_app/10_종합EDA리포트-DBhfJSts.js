...
assessment:
  ...
  - id: seaborn_10-eda-evidence-report-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 고객 이탈 데이터 EDA를 품질, 단변량, 관계, 한계 panel로 재현한다.'
  ...
  - id: seaborn_10-eda-evidence-report-interpretation-retrieval-retrieval
    ...
    goal: 탐색 결과가 품질·분포·관계·한계 순서로 재현되는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
