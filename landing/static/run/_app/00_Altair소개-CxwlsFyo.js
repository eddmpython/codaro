...
assessment:
  ...
  - id: altair_00-altair-grammar-contract-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 새 실험 데이터의 quantitative 축과 nominal group을 선언형 spec으로 표현한다.'
  ...
  - id: altair_00-altair-grammar-contract-interpretation-retrieval-retrieval
    ...
    goal: 데이터 field type과 encoding channel이 명시적인가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
