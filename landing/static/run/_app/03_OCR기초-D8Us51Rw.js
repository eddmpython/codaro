...
assessment:
  ...
  - id: visionApps_03-ocr_basic-result-reconciliation-transfer
    ...
    goal: OCR 기초 결과의 sourceHash, ocrEngineHash, language identity와 characterCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionApps_03-ocr_basic-evidence-recall-retrieval
    ...
    goal: OCR 기초의 admission, process, release 단계별 action, evidence, risk를 기억에서 복원한다.
