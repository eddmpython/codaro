...
assessment:
  ...
  - id: deepVision_04-similarity_search-result-reconciliation-transfer
    ...
    goal: 유사도 검색 결과의 queryHash, indexVersion, modelHash identity와 topScore metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_04-similarity_search-evidence-recall-retrieval
    ...
    goal: 유사도 검색의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
