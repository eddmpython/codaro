...
assessment:
  ...
  - id: visionFeatures_09-object_tracker-result-reconciliation-transfer
    ...
    goal: 객체 트래커 결과의 videoHash, trackId identity와 successfulFrames metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_09-object_tracker-evidence-recall-retrieval
    ...
    goal: 객체 트래커의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
