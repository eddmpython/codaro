...
assessment:
  ...
  - id: altair_07-interactive-filter-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 산점도 brush가 아래 상세 table을 filter하고 선택 수를 표시한다.'
  ...
  - id: altair_07-interactive-filter-interpretation-retrieval-retrieval
    ...
    goal: selection parameter와 filter 대상이 눈에 보이는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
