...
assessment:
  ...
  - id: opencv_06-binary_threshold-result-reconciliation-transfer
    ...
    goal: 이진화 스튜디오 결과의 sourceHash, thresholdConfig identity와 foregroundRatio metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: opencv_06-binary_threshold-evidence-recall-retrieval
    ...
    goal: 이진화 스튜디오의 source, operation, result 단계별 action, evidence, risk를 기억에서 복원한다.
