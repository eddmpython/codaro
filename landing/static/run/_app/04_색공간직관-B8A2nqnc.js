...
assessment:
  ...
  - id: visionBasics_04-color_space-result-reconciliation-transfer
    ...
    goal: 색공간 직관 결과의 sourceHash, outputSpace identity와 maxRoundTripError metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionBasics_04-color_space-evidence-recall-retrieval
    ...
    goal: 색공간 직관의 input, process, result 단계별 action, evidence, risk를 기억에서 복원한다.
