...
assessment:
  ...
  - id: pillow_10-image_editor-result-reconciliation-transfer
    ...
    goal: 종합 이미지 에디터 결과의 sourceHash, recipeHash identity와 outputBytes metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: pillow_10-image_editor-evidence-recall-retrieval
    ...
    goal: 종합 이미지 에디터의 source, edit, artifact 단계별 action, evidence, risk를 기억에서 복원한다.
