...
assessment:
  ...
  - id: altair_09-advanced-transform-order-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 계산된 단위 가격을 filter한 뒤 지역 집계와 순위를 만드는 선언형 pipeline을 구성한다.'
  ...
  - id: altair_09-advanced-transform-order-interpretation-retrieval-retrieval
    ...
    goal: calculate·filter·aggregate·window 순서가 결과 grain을 지키는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
