...
assessment:
  ...
  - id: seaborn_03-penguin-violin-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 기종별 latency 분포를 리전으로 split하되 관측점과 quartile을 함께 보인다.'
  ...
  - id: seaborn_03-penguin-violin-interpretation-retrieval-retrieval
    ...
    goal: 매끈한 density가 작은 표본을 과장하지 않는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
