...
assessment:
  ...
  - id: plotly_03-iris-3d-restraint-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 세 장비 유형의 두 핵심 feature를 symbol과 color로 중복 구분한다.'
  ...
  - id: plotly_03-iris-3d-restraint-interpretation-retrieval-retrieval
    ...
    goal: 차원 추가가 실제 분리를 돕고 2D 대안을 제공하는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
