...
assessment:
  ...
  - id: visionBasics_03-channel_structure-result-reconciliation-transfer
    ...
    goal: 채널 구조 분해 결과의 sourceHash, colorOrder identity와 channelMean metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionBasics_03-channel_structure-evidence-recall-retrieval
    ...
    goal: 채널 구조 분해의 input, process, result 단계별 action, evidence, risk를 기억에서 복원한다.
