...
assessment:
  ...
  - id: altair_04-penguin-facet-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 장비 유형은 color, 운영 지역은 facet으로 분리해 두 측정값을 비교한다.'
  ...
  - id: altair_04-penguin-facet-interpretation-retrieval-retrieval
    ...
    goal: species와 island를 color 하나에 과적재하지 않는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
