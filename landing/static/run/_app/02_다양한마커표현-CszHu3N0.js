...
assessment:
  ...
  - id: folium_02-marker-semantics-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 시설 운영 상태를 color와 icon 중복 encoding, 안전한 popup으로 표시한다.'
  ...
  - id: folium_02-marker-semantics-interpretation-retrieval-retrieval
    ...
    goal: marker 색·icon·popup이 같은 범주 의미를 일관되게 전달하는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
