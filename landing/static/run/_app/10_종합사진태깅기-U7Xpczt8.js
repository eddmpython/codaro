...
assessment:
  ...
  - id: deepVision_10-photo_tagger-result-reconciliation-transfer
    ...
    goal: 종합 사진 태깅기 결과의 sourceHash, pipelineHash, modelBundleHash identity와 tagCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_10-photo_tagger-evidence-recall-retrieval
    ...
    goal: 종합 사진 태깅기의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
