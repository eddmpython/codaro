...
assessment:
  ...
  - id: visionFeatures_10-video_roi_capstone-result-reconciliation-transfer
    ...
    goal: 영상 ROI 추적기 결과의 videoHash, trackId identity와 evidenceFrames metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_10-video_roi_capstone-evidence-recall-retrieval
    ...
    goal: 영상 ROI 추적기의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
