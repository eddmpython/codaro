...
assessment:
  ...
  - id: visionFeatures_05-panorama-result-reconciliation-transfer
    ...
    goal: 파노라마 스티칭 결과의 sourceSetHash, stitchOrderHash identity와 coverageRatio metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_05-panorama-evidence-recall-retrieval
    ...
    goal: 파노라마 스티칭의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
