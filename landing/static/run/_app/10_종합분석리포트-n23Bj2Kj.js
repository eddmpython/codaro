...
assessment:
  ...
  - id: matplotlib_10-analysis-report-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 분기 성과 report에 데이터 품질, 비교 차트, 한계 문장을 함께 배치한다.'
  ...
  - id: matplotlib_10-analysis-report-interpretation-retrieval-retrieval
    ...
    goal: 질문·분모·차트·결론이 같은 증거 사슬을 이루는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
