...
assessment:
  ...
  - id: visionApps_02-qr_barcode-result-reconciliation-transfer
    ...
    goal: QR·바코드 리더 결과의 sourceHash, decoderVersion identity와 decodedCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionApps_02-qr_barcode-evidence-recall-retrieval
    ...
    goal: QR·바코드 리더의 admission, process, release 단계별 action, evidence, risk를 기억에서 복원한다.
