...
assessment:
  ...
  - id: seaborn_00-seaborn-semantic-contract-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 실험 조건별 두 수치 변수 관계를 hue와 marker로 비교한다.'
  ...
  - id: seaborn_00-seaborn-semantic-contract-interpretation-retrieval-retrieval
    ...
    goal: 통계 집계와 semantic mapping이 질문에 맞는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
