...
assessment:
  ...
  - id: visionBasics_10-mini_correction-result-reconciliation-transfer
    ...
    goal: 미니 보정기 결과의 sourceHash, recipeHash identity와 meanLuma metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionBasics_10-mini_correction-evidence-recall-retrieval
    ...
    goal: 미니 보정기의 input, process, result 단계별 action, evidence, risk를 기억에서 복원한다.
