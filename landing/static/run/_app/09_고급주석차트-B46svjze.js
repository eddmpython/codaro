...
assessment:
  ...
  - id: matplotlib_09-annotation-evidence-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 배포와 장애 이벤트를 서비스 지표 선 위에 근거 ID와 함께 주석 처리한다.'
  ...
  - id: matplotlib_09-annotation-evidence-interpretation-retrieval-retrieval
    ...
    goal: 주석이 데이터 근거와 정확히 연결되는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
