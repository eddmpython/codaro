...
assessment:
  ...
  - id: visionApps_09-screen_analysis-result-reconciliation-transfer
    ...
    goal: 화면 캡처 분석 결과의 captureHash, maskPolicyHash, sessionId identity와 visibleRegionCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionApps_09-screen_analysis-evidence-recall-retrieval
    ...
    goal: 화면 캡처 분석의 admission, process, release 단계별 action, evidence, risk를 기억에서 복원한다.
