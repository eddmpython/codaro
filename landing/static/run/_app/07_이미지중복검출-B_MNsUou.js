...
assessment:
  ...
  - id: visionApps_07-image_duplicate-result-reconciliation-transfer
    ...
    goal: 이미지 중복 검출 결과의 sourceSetHash, hashMethod identity와 duplicatePairCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionApps_07-image_duplicate-evidence-recall-retrieval
    ...
    goal: 이미지 중복 검출의 admission, process, release 단계별 action, evidence, risk를 기억에서 복원한다.
