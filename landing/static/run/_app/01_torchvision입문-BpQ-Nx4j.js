...
assessment:
  ...
  - id: deepVision_01-torchvision_runtime-result-reconciliation-transfer
    ...
    goal: torchvision 입문 결과의 modelHash, transformHash identity와 batchCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_01-torchvision_runtime-evidence-recall-retrieval
    ...
    goal: torchvision 입문의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
