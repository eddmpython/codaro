...
assessment:
  ...
  - id: folium_04-tile-style-access-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 시설 overlay와 충분한 contrast를 가진 tile을 attribution과 함께 제공한다.'
  ...
  - id: folium_04-tile-style-access-interpretation-retrieval-retrieval
    ...
    goal: basemap style이 overlay 대비와 attribution을 해치지 않는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
