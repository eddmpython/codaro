...
assessment:
  ...
  - id: plotly_01-life-expectancy-comparison-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 같은 분기의 국가별 서비스 가용성을 지역 색과 hover 표본 수로 비교한다.'
  ...
  - id: plotly_01-life-expectancy-comparison-interpretation-retrieval-retrieval
    ...
    goal: 국가별 비교가 같은 연도와 population context를 쓰는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
