...
assessment:
  ...
  - id: opencv_07-morphology-result-reconciliation-transfer
    ...
    goal: 모폴로지 연산기 결과의 sourceHash, morphologyHash identity와 componentCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: opencv_07-morphology-evidence-recall-retrieval
    ...
    goal: 모폴로지 연산기의 source, operation, result 단계별 action, evidence, risk를 기억에서 복원한다.
