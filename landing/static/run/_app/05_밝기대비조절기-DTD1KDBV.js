...
assessment:
  ...
  - id: pillow_05-brightness_contrast-result-reconciliation-transfer
    ...
    goal: 밝기·대비 조절기 결과의 sourceHash, recipeHash identity와 clippedRatio metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: pillow_05-brightness_contrast-evidence-recall-retrieval
    ...
    goal: 밝기·대비 조절기의 source, edit, artifact 단계별 action, evidence, risk를 기억에서 복원한다.
