...
assessment:
  ...
  - id: deepVision_08-transfer_learning-result-reconciliation-transfer
    ...
    goal: 전이학습 결과의 datasetHash, baseModelHash, splitHash identity와 validationAccuracy metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_08-transfer_learning-evidence-recall-retrieval
    ...
    goal: 전이학습의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
