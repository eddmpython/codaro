...
assessment:
  ...
  - id: visionApps_10-photo_organizer-result-reconciliation-transfer
    ...
    goal: 종합 사진 정리기 결과의 sourceSetHash, planHash, policyHash identity와 plannedMoves metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionApps_10-photo_organizer-evidence-recall-retrieval
    ...
    goal: 종합 사진 정리기의 admission, process, release 단계별 action, evidence, risk를 기억에서 복원한다.
