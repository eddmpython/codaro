...
assessment:
  ...
  - id: visionBasics_06-pixel_arithmetic-result-reconciliation-transfer
    ...
    goal: 픽셀 산술 결과의 sourceHash, clipMode identity와 clippedRatio metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionBasics_06-pixel_arithmetic-evidence-recall-retrieval
    ...
    goal: 픽셀 산술의 input, process, result 단계별 action, evidence, risk를 기억에서 복원한다.
