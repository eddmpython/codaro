...
assessment:
  ...
  - id: visionFeatures_04-homography-result-reconciliation-transfer
    ...
    goal: 호모그래피 정렬 결과의 queryHash, referenceHash identity와 reprojectionError metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_04-homography-evidence-recall-retrieval
    ...
    goal: 호모그래피 정렬의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
