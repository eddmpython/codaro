...
assessment:
  ...
  - id: matplotlib_07-dual-axis-time-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 트래픽과 오류율을 공통 기준일 index로 정규화해 비교한다.'
  ...
  - id: matplotlib_07-dual-axis-time-interpretation-retrieval-retrieval
    ...
    goal: 서로 다른 단위가 같은 추세처럼 보이지 않게 했는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
