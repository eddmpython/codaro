...
assessment:
  ...
  - id: seaborn_01-iris-semantic-scatter-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 장비 유형별 온도와 진동 관계를 색·marker 중복 encoding으로 비교한다.'
  ...
  - id: seaborn_01-iris-semantic-scatter-interpretation-retrieval-retrieval
    ...
    goal: 품종 분리가 색 하나에만 의존하지 않는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
