...
assessment:
  ...
  - id: matplotlib_08-multipanel-dashboard-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 운영 dashboard의 트래픽·지연·오류 패널을 동일 기간 필터로 연결한다.'
  ...
  - id: matplotlib_08-multipanel-dashboard-interpretation-retrieval-retrieval
    ...
    goal: 패널마다 다른 grain을 공통 필터와 연결했는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
