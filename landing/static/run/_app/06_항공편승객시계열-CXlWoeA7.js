...
assessment:
  ...
  - id: seaborn_06-flight-seasonality-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 월·연도별 전력 수요를 고정 color scale heatmap으로 비교한다.'
  ...
  - id: seaborn_06-flight-seasonality-interpretation-retrieval-retrieval
    ...
    goal: 장기 추세와 월별 계절성을 같은 행렬에서 구분하는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
