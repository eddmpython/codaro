...
assessment:
  ...
  - id: seaborn_07-life-expectancy-facets-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 지역별 서비스 가용성의 장기 추세를 region facet과 동일 y scale로 비교한다.'
  ...
  - id: seaborn_07-life-expectancy-facets-interpretation-retrieval-retrieval
    ...
    goal: 국가·대륙의 계층과 시간 변화가 섞이지 않았는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
