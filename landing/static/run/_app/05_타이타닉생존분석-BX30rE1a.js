...
assessment:
  ...
  - id: altair_05-titanic-aggregate-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 요금제·채널별 전환율을 known outcome count와 함께 집계한다.'
  ...
  - id: altair_05-titanic-aggregate-interpretation-retrieval-retrieval
    ...
    goal: binary mean이 생존율이며 NULL 분모를 제외한다고 명시했는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
