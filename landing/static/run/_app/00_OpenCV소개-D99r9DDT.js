...
assessment:
  ...
  - id: opencv_00-opencv_runtime-result-reconciliation-transfer
    ...
    goal: OpenCV 실행 계약 결과의 sourceHash, decoder identity와 decodedPixels metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: opencv_00-opencv_runtime-evidence-recall-retrieval
    ...
    goal: OpenCV 실행 계약의 source, operation, result 단계별 action, evidence, risk를 기억에서 복원한다.
