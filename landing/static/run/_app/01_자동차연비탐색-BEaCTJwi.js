...
assessment:
  ...
  - id: altair_01-car-efficiency-encoding-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 장비 출력과 효율 관계를 제조 지역 색과 hover 모델 정보로 탐색한다.'
  ...
  - id: altair_01-car-efficiency-encoding-interpretation-retrieval-retrieval
    ...
    goal: 마력·연비 관계에서 origin과 model year 역할이 분리되는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
