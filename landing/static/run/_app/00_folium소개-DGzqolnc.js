...
assessment:
  ...
  - id: folium_00-folium-map-contract-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 두 물류 거점의 좌표를 검증하고 bounds에 맞춰 초기 지도를 설정한다.'
  ...
  - id: folium_00-folium-map-contract-interpretation-retrieval-retrieval
    ...
    goal: 좌표·zoom·tile 출처가 지도 목적에 맞는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
