...
assessment:
  ...
  - id: plotly_00-plotly-interaction-contract-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 두 실험 series의 값을 hover 세부 정보와 함께 비교한다.'
  ...
  - id: plotly_00-plotly-interaction-contract-interpretation-retrieval-retrieval
    ...
    goal: interaction이 질문에 필요한 세부 정보만 제공하는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
