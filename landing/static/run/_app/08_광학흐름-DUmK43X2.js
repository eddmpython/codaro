...
assessment:
  ...
  - id: visionFeatures_08-optical_flow-result-reconciliation-transfer
    ...
    goal: 광학 흐름 결과의 previousFrameHash, currentFrameHash identity와 trackedRatio metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_08-optical_flow-evidence-recall-retrieval
    ...
    goal: 광학 흐름의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
