...
assessment:
  ...
  - id: deepVision_03-embedding_vector-result-reconciliation-transfer
    ...
    goal: 임베딩 벡터 결과의 sourceHash, modelHash identity와 vectorNorm metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_03-embedding_vector-evidence-recall-retrieval
    ...
    goal: 임베딩 벡터의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
