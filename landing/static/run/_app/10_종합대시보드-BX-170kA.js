...
assessment:
  ...
  - id: plotly_10-plotly-dashboard-release-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 운영 dashboard의 filter state와 핵심 설명이 정적 export에도 남도록 구성한다.'
  ...
  - id: plotly_10-plotly-dashboard-release-interpretation-retrieval-retrieval
    ...
    goal: interaction 없이도 핵심 결론과 현재 scope를 읽을 수 있는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
