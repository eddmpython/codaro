...
assessment:
  ...
  - id: visionApps_04-korean_ocr-result-reconciliation-transfer
    ...
    goal: 한국어 OCR 결과의 sourceHash, ocrEngineHash, dictionaryVersion identity와 hangulSyllableCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionApps_04-korean_ocr-evidence-recall-retrieval
    ...
    goal: 한국어 OCR의 admission, process, release 단계별 action, evidence, risk를 기억에서 복원한다.
