...
assessment:
  ...
  - id: folium_01-first-map-view-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 세 서비스 센터를 누락 없이 포함하는 initial bounds를 계산한다.'
  ...
  - id: folium_01-first-map-view-interpretation-retrieval-retrieval
    ...
    goal: 초기 center와 zoom이 모든 위치를 보이게 하는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
