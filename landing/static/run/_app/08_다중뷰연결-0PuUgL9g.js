...
assessment:
  ...
  - id: altair_08-linked-multiview-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: overview 기간 brush가 category summary와 row detail에 같은 scope로
      전달된다.'
  ...
  - id: altair_08-linked-multiview-interpretation-retrieval-retrieval
    ...
    goal: 선택이 서로 다른 grain의 view에 올바르게 전파되는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
