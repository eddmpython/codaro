...
assessment:
  ...
  - id: visionApps_06-face_embedding-result-reconciliation-transfer
    ...
    goal: 얼굴 임베딩 비교 결과의 leftSourceHash, rightSourceHash, modelHash identity와 similarity metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionApps_06-face_embedding-evidence-recall-retrieval
    ...
    goal: 얼굴 임베딩 비교의 admission, process, release 단계별 action, evidence, risk를 기억에서 복원한다.
