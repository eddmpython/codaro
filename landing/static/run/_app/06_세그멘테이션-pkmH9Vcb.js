...
assessment:
  ...
  - id: deepVision_06-segmentation-result-reconciliation-transfer
    ...
    goal: 세그멘테이션 결과의 sourceHash, modelHash, classMapHash identity와 foregroundRatio metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_06-segmentation-evidence-recall-retrieval
    ...
    goal: 세그멘테이션의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
