...
assessment:
  ...
  - id: folium_07-choropleth-rate-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 지역별 장애 건수를 요청 수로 정규화한 rate 단계구분도를 만든다.'
  ...
  - id: folium_07-choropleth-rate-interpretation-retrieval-retrieval
    ...
    goal: 지역 면적이 아니라 정규화된 rate를 color로 비교하는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
