...
assessment:
  ...
  - id: seaborn_09-mpg-multivariate-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 장비 특성 여러 개와 에너지 효율의 관계를 pair grid로 탐색한다.'
  ...
  - id: seaborn_09-mpg-multivariate-interpretation-retrieval-retrieval
    ...
    goal: 다변량 탐색에서 같은 변수를 반복 해석하지 않는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
