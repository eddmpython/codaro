...
assessment:
  ...
  - id: deepVision_07-pose_estimation-result-reconciliation-transfer
    ...
    goal: 포즈 추정 결과의 sourceHash, modelHash, skeletonHash identity와 visibleJoints metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_07-pose_estimation-evidence-recall-retrieval
    ...
    goal: 포즈 추정의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
