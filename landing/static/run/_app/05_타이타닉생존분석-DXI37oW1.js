...
assessment:
  ...
  - id: seaborn_05-titanic-survival-estimate-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 요금제와 채널별 전환율을 유효 사용자 수와 interval로 비교한다.'
  ...
  - id: seaborn_05-titanic-survival-estimate-interpretation-retrieval-retrieval
    ...
    goal: 범주별 생존율의 유효 분모와 불확실성을 보여주는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
