...
assessment:
  ...
  - id: folium_09-marker-cluster-detail-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 수천 개 장비 위치를 cluster count와 category detail을 잃지 않게 탐색한다.'
  ...
  - id: folium_09-marker-cluster-detail-interpretation-retrieval-retrieval
    ...
    goal: cluster count와 개별 marker 상세가 zoom에 따라 보존되는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
