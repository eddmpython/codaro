...
assessment:
  ...
  - id: folium_03-map-geometries-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 배송 반경, 서비스 구역, 이동 경로를 geometry별 단위와 legend로 구분한다.'
  ...
  - id: folium_03-map-geometries-interpretation-retrieval-retrieval
    ...
    goal: circle 반경과 polygon 좌표 단위가 명확한가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
