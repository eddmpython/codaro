...
assessment:
  ...
  - id: deepVision_05-object_detection-result-reconciliation-transfer
    ...
    goal: 객체 탐지 결과의 sourceHash, modelHash, labelMapHash identity와 detectionCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: deepVision_05-object_detection-evidence-recall-retrieval
    ...
    goal: 객체 탐지의 source, inference, result 단계별 action, evidence, risk를 기억에서 복원한다.
