...
assessment:
  ...
  - id: visionFeatures_02-orb_features-result-reconciliation-transfer
    ...
    goal: ORB 특징점 결과의 sourceHash, descriptorType identity와 descriptorCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionFeatures_02-orb_features-evidence-recall-retrieval
    ...
    goal: ORB 특징점의 source, estimate, verify 단계별 action, evidence, risk를 기억에서 복원한다.
