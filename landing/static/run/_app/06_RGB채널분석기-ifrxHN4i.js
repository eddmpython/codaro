...
assessment:
  ...
  - id: pillow_06-rgb_channel_analysis-result-reconciliation-transfer
    ...
    goal: RGB 채널 분석기 결과의 sourceHash, colorOrder identity와 histogramCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: pillow_06-rgb_channel_analysis-evidence-recall-retrieval
    ...
    goal: RGB 채널 분석기의 source, edit, artifact 단계별 action, evidence, risk를 기억에서 복원한다.
