...
assessment:
  ...
  - id: folium_08-heatmap-weight-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 호출 위치의 건수와 severity weight를 구분한 공간 heatmap을 만든다.'
  ...
  - id: folium_08-heatmap-weight-interpretation-retrieval-retrieval
    ...
    goal: 점 밀도와 weight 합을 인구·수요로 오해하지 않는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
