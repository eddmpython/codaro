...
assessment:
  ...
  - id: plotly_05-world-population-map-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 국가별 고객 수를 ISO code 검증과 log color scale이 있는 지도에 표시한다.'
  ...
  - id: plotly_05-world-population-map-interpretation-retrieval-retrieval
    ...
    goal: 위치 code와 color 분모가 지도 geometry에 정확히 결합되는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
