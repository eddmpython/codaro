...
assessment:
  ...
  - id: opencv_01-opencv_structure-result-reconciliation-transfer
    ...
    goal: 이미지 구조 탐색기 결과의 sourceHash, layout identity와 byteCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: opencv_01-opencv_structure-evidence-recall-retrieval
    ...
    goal: 이미지 구조 탐색기의 source, operation, result 단계별 action, evidence, risk를 기억에서 복원한다.
