...
assessment:
  ...
  - id: altair_02-iris-type-separation-encoding-transfer-transfer
    ...
    goal: '다음 새 문맥에서도 mark·axis·transform·interaction 책임을 재현한다: 세 제품 유형을 두 품질 지표와 legend filter로 비교한다.'
  ...
  - id: altair_02-iris-type-separation-interpretation-retrieval-retrieval
    ...
    goal: 품종 nominal encoding과 수치 scale이 schema에 맞는가 다시 판단할 때 차트 선택과 증거 한계를 구분한다.
