...
assessment:
  ...
  - id: visionBasics_08-image_mask-result-reconciliation-transfer
    ...
    goal: 마스크 사고 결과의 sourceHash, maskHash identity와 foregroundCount metric을 허용 오차 안에서 함께 검증한다.
  ...
  - id: visionBasics_08-image_mask-evidence-recall-retrieval
    ...
    goal: 마스크 사고의 input, process, result 단계별 action, evidence, risk를 기억에서 복원한다.
