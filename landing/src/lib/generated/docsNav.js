export const docsPages = [
  ...
  },
  {
    ...
    "html": "<h1>Installation</h1>\n<p>Codaro uses <code>uv</code> for Python environment and execution.</p>\n<h2>Requirements</h2>\n<ul>\n<li>Python 3.12 or newer</li>\n<li><code>uv</code></li>\n<li>Node.js for the Svelte public site and local editor frontends</li>\n</ul>\n<h2>Core commands</h2>\n<pre><code class=\"language-bash\">uv run codaro\nuv run codaro path.py\nuv run pytest tests/ -v\n</code></pre>\n<h2>Public site</h2>\n<p>The public site lives in <code>landing/</code>.</p>\n<p>Use:</p>\n<pre><code class=\"language-bash\">cd landing\nnpm install\nnpm run build\n</code></pre>\n",
    "text": "Installation Codaro uses for Python environment and execution. Requirements Python 3.12 or newer Node.js for the Svelte public site and local editor frontends Core commands Public site The public site lives in . Use:"
  },
  {
