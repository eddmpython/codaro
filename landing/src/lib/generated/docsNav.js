export const docsPages = [
  ...
  },
  {
    ...
    "html": "<h1>제품 프론트 표면</h1>\n<p>Codaro의 프론트는 두 표면으로 나눈다.</p>\n<ul>\n<li><code>landing/</code> — GitHub Pages 문서와 글쓰기 표면. 현재 Svelte 유지.</li>\n<li><code>editor/</code> — Codaro 제품 표면. AI workbench, notebook/editor, learning, automation UI를 모두 포함한다. React + shadcn/ui 기준.</li>\n</ul>\n<p>기존 Svelte <code>editor/</code> 앱은 더 이상 제품 표면의 기준이 아니다. 현재 제품 표면의 source of truth는 <code>editor/</code> 하나다.</p>\n<h2>제품 표면 계약</h2>\n<ul>\n<li><code>editor/</code>가 Codaro의 실제 제품 UI 표면이다.</li>\n<li>제품 내부 실행/편집 단위는 workbench, notebook, cell로 구분한다.</li>\n<li>기존 Svelte 편집기는 참고/레거시 판단 대상일 뿐, 현재 저장소의 제품 기준으로 보지 않는다.</li>\n<li>제품 기본 진입은 <code>Chat-first AI workbench</code>다.</li>\n<li>제품 흐름은 <code>chat → YAML curriculum → learning editor cells → cell read/write/call → task/report/automation</code>이다.</li>\n</ul>\n<p>따라서 새 UI 판단 기준은 &quot;편집기 앱을 어떻게 꾸밀까&quot;가 아니라 &quot;채팅에서 만들어진 학습/자동화 작업대가 어떻게 실제 셀과 실행 상태로 변하는가&quot;다.</p>\n<h2>작업대 정보 구조</h2>\n<p><code>editor/</code>는 아래 정보를 1급 UI로 보여줘야 한다.</p>\n<ul>\n<li>현재 conversation과 provider/model 상태</li>\n<li>AI가 작성한 curriculum YAML artifact</li>\n<li>materialized document와 cell 목록</li>\n<li>tool lane timeline: <code>curriculum</code>, <code>read</code>, <code>write</code>, <code>cell-call</code>, <code>progress</code>, <code>automation</code>, <code>safety</code></li>\n<li>cell별 실행 결과, 변수 상태, 검증 결과</li>\n<li>pending workbench changes의 diff, accept/reject</li>\n<li>AI 없이 불러온 reference curriculum과 AI가 생성한 임시 curriculum의 출처 차이</li>\n<li>task/report/automation으로 넘기는 handoff 상태</li>\n</ul>\n<h2>결정</h2>\n<ul>\n<li>편집기와 학습기 프론트의 신규 작업은 React + shadcn/ui 컴포넌트 구조를 기본값으로 한다.</li>\n<li>shadcn/ui는 완성된 외부 라이브러리를 가져다 쓰는 방식이 아니라, 컴포넌트 코드를 소유하고 조정하는 방식으로 사용한다.</li>\n<li>화면의 난이도는 컴포넌트 자체보다 배치, 상태, 정보 밀도에서 결정한다. 따라서 새 화면은 먼저 레이아웃 계약을 고정한 뒤 기능을 붙인다.</li>\n<li>공용 컴포넌트는 <code>editor/src/components/ui/</code> 아래에 둔다.</li>\n<li>제품 기능 화면은 <code>editor/src/</code> 아래에서 AI workbench, notebook/editor, learning, runtime 패널을 분리해 키운다.</li>\n</ul>\n<h2>편집기 기준</h2>\n<ul>\n<li>편집기는 코드 셀, 실행 결과, 런타임 상태, 파일 탐색이 한 화면에서 끊기지 않아야 한다.</li>\n<li>실행 버튼, 저장, 검색, 명령 팔레트 같은 기본 행동은 shadcn 버튼/탭/패널 패턴 위에서 만든다.</li>\n<li>코드 편집 영역은 별도 엔진 영역으로 보고, 주변 크롬은 shadcn/ui 컴포넌트로 구성한다.</li>\n<li>출력은 셀 바로 아래에 붙이며, 실행 상태는 셀과 런타임 패널 양쪽에서 확인 가능해야 한다.</li>\n</ul>\n<h2>학습기 기준</h2>\n<ul>\n<li>학습기는 설명 페이지가 아니라 실행 흐름이다.</li>\n<li>한 화면에는 현재 목표, 실습 셀, 예측/실행/수정 단계, 피드백 패널이 함께 보여야 한다.</li>\n<li>초보자용 문구는 화면에서 직접 행동을 유도해야 한다. 용어 설명은 기능 사용을 막지 않는 위치에 둔다.</li>\n<li>진행률은 단순 퍼센트보다 현재 단계와 다음 행동을 우선한다.</li>\n<li>학습 요청의 기본값은 reference tree 선택이 아니라 채팅에서 작업대를 생성하는 것이다.</li>\n<li>reference tree는 AI 없이도 학습 가능한 <code>curricula/</code> 기본 curriculum 경로다.</li>\n<li>AI 생성 curriculum은 YAML artifact와 셀 전개 결과를 함께 보여준다.</li>\n</ul>\n<h2>경계</h2>\n<ul>\n<li><code>editor/</code>는 React + shadcn/ui 제품 표면이다.</li>\n<li><code>editor/</code>의 빌드 결과는 <code>src/codaro/webBuild/</code>로 간다.</li>\n<li>폐기된 Svelte 편집기는 현재 저장소의 제품 기준에서 제외한다.</li>\n<li><code>landing/</code>은 이 결정의 대상이 아니다. 문서 사이트 전환은 별도 결정 없이는 하지 않는다.</li>\n</ul>\n<h2>관련</h2>\n<ul>\n<li>[[overview]] — UI는 실행기 구현 세부사항에 직접 묶이지 않는다</li>\n<li>[[widget-bridge]] — Python descriptor와 프론트 렌더링 경계</li>\n<li>[[learning-three-pillars]] — 학습 모드의 콘텐츠와 철학</li>\n</ul>\n",
  ...
  },
  {
    ...
    "html": "<h1>Codaro Skills</h1>\n<p>Codaro의 사람 + AI 공용 SSOT. 한 마크다운 파일이 두 청중을 동시에 섬긴다 — 사람은 직접 읽고, AI는 같은 파일을 컨텍스트로 받는다.</p>\n<h2>문서 구조 결정</h2>\n<p>Codaro의 저장소 문서는 두 축만 둔다.</p>\n<ul>\n<li><code>docs/skills/</code> — 제품 사상, 아키텍처, 운영 규칙의 SSOT.</li>\n<li><code>docs/blog/</code> — 공개 글, 릴리즈 스토리, 긴 설명형 콘텐츠.</li>\n<li><code>curricula/</code> — 문서가 아니라 제품이 읽는 기본 curriculum YAML 레지스트리.</li>\n</ul>\n<p><code>docs/concepts/</code>, <code>docs/guides/</code>, <code>docs/reference/</code>, <code>docs/getting-started/</code>, <code>docs/branding/</code> 같은 별도 문서 폴더는 유지하지 않는다. 필요한 내용은 <code>docs/skills/identity</code>, <code>docs/skills/architecture</code>, <code>docs/skills/ops</code> 중 하나로 흡수한다.</p>\n<p>README는 외부 진입점이다. 제품 철학 전체를 README에 길게 복사하지 않고, 바로 시작 링크와 현재 공개 배포 상태만 둔다.</p>\n<h2>제품 사상</h2>\n<p>Codaro의 제품 표면은 <code>editor/</code>다. 현재 <code>editor/</code>는 React + shadcn/ui 기준이며, 기존 Svelte 편집기는 제품 기준에서 제외한다.</p>\n<p>기본 흐름은 아래와 같다.</p>\n<pre><code class=\"language-text\">Chat-first AI workbench\n→ AI가 curriculum YAML 작성\n→ learning editor에 runnable cells 전개\n→ read/write/cell-call로 셀 단위 실행/검증\n→ 완성된 .py 노트북을 task/report/automation으로 확장\n</code></pre>\n<p>핵심 계약:</p>\n<ul>\n<li>YAML은 학습 설계도의 source of truth다.</li>\n<li>기본 curriculum YAML은 <code>curricula/</code>에 둔다.</li>\n<li>Editor는 Codaro 제품 표면의 이름이다. 내부 실행 단위는 workbench/notebook/cell로 구분한다.</li>\n<li>Tool call은 숨겨진 내부 로그가 아니라 사용자가 검토할 수 있는 제품 액션이다.</li>\n<li>AI 없이도 기본 curriculum YAML로 학습이 가능해야 한다.</li>\n<li>AI가 붙으면 개인화, 셀 조율, 답 검증, 자동화 생성이 추가된다.</li>\n</ul>\n<h2>DartLab에서 가져올 점</h2>\n<p>DartLab은 <code>blog/</code>와 skills를 분리하고, AI가 읽을 작업 지식은 skills에 모은다. Codaro도 같은 원칙을 따르되 공개 사이트가 <code>docs/</code>를 기준으로 동작하므로 루트 <code>blog/</code>를 만들지 않고 <code>docs/blog/</code>를 유지한다.</p>\n<p>DartLab의 generated reference처럼 코드에서 자동 생성되는 API 표가 필요해지면 별도 <code>docs/reference/</code>를 만들지 말고 <code>docs/skills/architecture</code> 또는 <code>docs/skills/ops</code> 아래의 생성 파일로 둔다.</p>\n<p>각 스킬은 5필드 frontmatter를 가진다:</p>\n<pre><code class=\"language-yaml\">---\nid: kebab-case-id\ntitle: Title\ncategory: identity | architecture | ops\npurpose: 한 줄 — 이 문서가 존재하는 이유\nwhenToUse: 트리거 상황 또는 검색 키워드\n---\n</code></pre>\n<h2>Identity (11) — 절대 흔들리지 않는 사상</h2>\n<ul>\n<li><a href=\"skills/identity/transparent-scope-isolation\">transparent-scope-isolation</a></li>\n<li><a href=\"skills/identity/reactive-execution\">reactive-execution</a></li>\n<li><a href=\"skills/identity/percent-format\">percent-format</a></li>\n<li><a href=\"skills/identity/pyodide-first-runtime\">pyodide-first-runtime</a></li>\n<li><a href=\"skills/identity/learning-three-pillars\">learning-three-pillars</a></li>\n<li><a href=\"skills/identity/ai-integration\">ai-integration</a></li>\n<li><a href=\"skills/identity/mounting-and-integration\">mounting-and-integration</a></li>\n<li><a href=\"skills/identity/automation-tasks-reports\">automation-tasks-reports</a></li>\n<li><a href=\"skills/identity/multi-editor-modes\">multi-editor-modes</a></li>\n<li><a href=\"skills/identity/ai-sensory-system\">ai-sensory-system</a></li>\n<li><a href=\"skills/identity/external-channels-mobile\">external-channels-mobile</a></li>\n</ul>\n<h2>Architecture (7) — 5층 구조</h2>\n<ul>\n<li><a href=\"skills/architecture/overview\">overview</a></li>\n<li><a href=\"skills/architecture/document-model\">document-model</a></li>\n<li><a href=\"skills/architecture/execution-engine\">execution-engine</a></li>\n<li><a href=\"skills/architecture/dataflow\">dataflow</a></li>\n<li><a href=\"skills/architecture/widget-bridge\">widget-bridge</a></li>\n<li><a href=\"skills/architecture/frontend-product-surface\">frontend-product-surface</a></li>\n<li><a href=\"skills/architecture/curriculum-registry\">curriculum-registry</a></li>\n</ul>\n<h2>Ops (10) — 운영 규칙</h2>\n<ul>\n<li><a href=\"skills/ops/environment\">environment</a></li>\n<li><a href=\"skills/ops/code-quality\">code-quality</a></li>\n<li><a href=\"skills/ops/ai-transparency\">ai-transparency</a></li>\n<li><a href=\"skills/ops/experiment\">experiment</a></li>\n<li><a href=\"skills/ops/branding\">branding</a></li>\n<li><a href=\"skills/ops/git-and-release\">git-and-release</a></li>\n<li><a href=\"skills/ops/licensing\">licensing</a></li>\n<li><a href=\"skills/ops/packaging\">packaging</a></li>\n<li><a href=\"skills/ops/doc-and-session\">doc-and-session</a></li>\n<li><a href=\"skills/ops/reference-impl\">reference-impl</a></li>\n</ul>\n<h2>후속 (PR 2 이후)</h2>\n<ul>\n<li><code>architecture/{document,kernel,runtime,system}.md</code> — 기존 src/codaro/*/DEV.md 본문 이관</li>\n<li><code>launcher/{packaging,provisioning,manifest,backend-lifecycle}.md</code> — launcher/PRD.md 530줄 분할</li>\n</ul>\n",
