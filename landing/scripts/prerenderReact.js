...
function mathCityBody() {
  return `<main class="mathCityRoot mc-repairRoot"><header class="mc-topbar"><button class="mc-brandButton" type="button" aria-label="수학도시 수리 스테이지"><span class="mc-brandMark" aria-hidden="true">10</span><span><strong>수상한 수학도시</strong><small>수학 부품으로 고치는 장난감 도시</small></span></button><nav class="mc-nav" aria-label="수학도시 메뉴"><button class="mc-iconButton" type="button" aria-label="수리 장치">M</button><button class="mc-iconButton" type="button" aria-label="능력">*</button><button class="mc-iconButton" type="button" aria-label="단서">?</button><button class="mc-iconButton" type="button" aria-label="설정">S</button></nav></header><section class="mc-repairScreen" aria-labelledby="mc-static-math-city-title"><div class="mc-repairIntro"><p class="mc-kicker">Season 1 · 사라진 숫자</p><h1 id="mc-static-math-city-title">멈춘 시계버스 정비소</h1><p>버스 시간표가 찢어져 2시 40분 뒤의 길이 비었다. 10분 부품으로 시간 길을 다시 잇는다.</p></div><div class="mc-repairLayout"><section class="mc-devicePanel" aria-label="시계버스 장치"><div class="mc-deviceHud"><span>현재 2:40</span><span>목표 3:00</span><span>1/4</span></div><svg class="mc-repairSvg mc-run-idle" viewBox="0 0 900 560" role="img" aria-labelledby="mc-static-device-title mc-static-device-desc"><title id="mc-static-device-title">시계버스 수리 장치</title><desc id="mc-static-device-desc">현재 시각과 목표 시각 사이에 10분 부품을 끼워 버스를 작동시키는 장치</desc><rect x="22" y="22" width="856" height="516" rx="28" class="mc-deviceBg"/><path d="M128 388 C238 334 330 386 444 340 C560 292 650 314 772 260" class="mc-deviceTrack"/><g transform="translate(72 74)"><rect x="26" y="196" width="156" height="168" rx="18" class="mc-deviceTower"/><path d="M6 202 L104 88 L204 202 Z" class="mc-deviceRoof"/><circle cx="104" cy="202" r="78" class="mc-deviceClock"/><line x1="104" y1="202" x2="104" y2="142" class="mc-hourHand"/><line x1="104" y1="202" x2="86" y2="170" class="mc-minuteHand"/><circle cx="104" cy="202" r="6" class="mc-pin"/><text x="104" y="310" text-anchor="middle" class="mc-deviceText">현재 2:40</text></g><g transform="translate(618 80)"><rect x="0" y="42" width="198" height="150" rx="18" class="mc-signBoard"/><rect x="30" y="70" width="138" height="46" rx="10" class="mc-signScreen"/><text x="99" y="101" text-anchor="middle" class="mc-deviceText">3:00 출발</text><rect x="50" y="134" width="98" height="34" rx="17" class="mc-lightOff"/><text x="99" y="156" text-anchor="middle" class="mc-lightText">대기</text></g><g class="mc-busRig" style="transform: translate(292px, 338px)"><rect x="0" y="38" width="154" height="78" rx="18" class="mc-repairBus"/><rect x="24" y="14" width="86" height="36" rx="10" class="mc-busWindow"/><text x="67" y="39" text-anchor="middle" class="mc-busTime">BUS</text><circle cx="36" cy="122" r="15" class="mc-wheel"/><circle cx="118" cy="122" r="15" class="mc-wheel"/></g><g transform="translate(178 444)"><g><rect x="0" y="0" width="152" height="64" rx="14" class="mc-deviceSlot mc-deviceSlot-target"/><text x="76" y="25" text-anchor="middle" class="mc-slotText">2:40 -> 2:50</text><text x="76" y="48" text-anchor="middle" class="mc-slotPartText">빈칸</text></g><g transform="translate(176 0)"><rect x="0" y="0" width="152" height="64" rx="14" class="mc-deviceSlot mc-deviceSlot-target"/><text x="76" y="25" text-anchor="middle" class="mc-slotText">2:50 -> 3:00</text><text x="76" y="48" text-anchor="middle" class="mc-slotPartText">빈칸</text></g><g transform="translate(352 0)"><rect x="0" y="0" width="152" height="64" rx="14" class="mc-deviceSlot mc-deviceSlot-overflow"/><text x="76" y="25" text-anchor="middle" class="mc-slotText">3:00 -> 3:10</text><text x="76" y="48" text-anchor="middle" class="mc-slotPartText">빈칸</text></g></g></svg></section><aside class="mc-workbench" aria-label="수리 조작대"><div class="mc-novaLine"><strong>노바</strong><span>시간 길이 10분씩 끊겨 있어. 맞는 만큼만 이어야 버스가 움직여.</span></div><button class="mc-lensButton" type="button" disabled>시간 렌즈 잠김</button><div class="mc-stageCard"><span>현재 장치</span><strong>시계버스 2:40 -> 3:00</strong><small>2:40에서 3:00까지 빈칸을 채운다.</small></div><div class="mc-partTray" aria-label="10분 부품 트레이"><div class="mc-sectionTitle"><span>10분 부품</span><small>시간 길에 들어갈 작은 톱니들.</small></div><div class="mc-partGrid"><button class="mc-timePart" type="button"><span>10</span><small>분</small></button><button class="mc-timePart" type="button"><span>10</span><small>분</small></button><button class="mc-timePart" type="button"><span>10</span><small>분</small></button></div></div><div class="mc-slotBoard" aria-label="장치 슬롯"><div class="mc-sectionTitle"><span>장치 슬롯</span><small>목표 뒤 붉은 칸은 지나친 시간이다.</small></div><div class="mc-slotGrid"><button class="mc-repairSlot mc-slot-target" type="button"><span>2:40 -> 2:50</span><strong>빈칸</strong></button><button class="mc-repairSlot mc-slot-target" type="button"><span>2:50 -> 3:00</span><strong>빈칸</strong></button><button class="mc-repairSlot mc-slot-overflow" type="button"><span>3:00 -> 3:10</span><strong>빈칸</strong></button></div></div><div class="mc-runControls"><button class="mc-runButton" type="button">작동</button><button class="mc-secondaryAction" type="button">다시 놓기</button></div><div class="mc-repairFeedback mc-feedback-idle" role="status"><span>시간 길이 이어지면 버스 바퀴가 먼저 반응해.</span></div></aside></div></section></main>`;
}
