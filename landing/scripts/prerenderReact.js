...
function mathCityBody() {
  return `<main class="mathCityRoot"><header class="mc-topbar"><button class="mc-brandButton" type="button" aria-label="수상한 수학도시"><span class="mc-brandMark" aria-hidden="true">M</span><span><strong>수상한 수학도시</strong><small>개념으로 고치는 도시</small></span></button></header><section class="mc-mapScreen" aria-labelledby="mc-static-math-city-title"><div class="mc-mapIntro"><p class="mc-kicker">Season 1 · 사라진 숫자</p><h1 id="mc-static-math-city-title">멈춘 시계탑을 조사하자</h1><p>시계가 2시 40분에서 멈추고, 버스 시간표에는 3시 출발이 남아 있다. 두 단서를 함께 보면 도시를 고칠 수 있다.</p></div><div class="mc-mapLayout"><div class="mc-cityStage" aria-label="수상한 수학도시 지도"><svg class="mc-citySvg" viewBox="0 0 760 520" role="img" aria-labelledby="mc-static-city-title mc-static-city-desc"><title id="mc-static-city-title">수상한 수학도시 지도</title><desc id="mc-static-city-desc">중앙 시계탑과 숫자 버스 정류장이 보이는 지도</desc><rect x="24" y="28" width="712" height="464" rx="28" class="mc-mapGround"/><path d="M100 370 C220 270 310 410 446 308 C548 232 616 266 688 196" class="mc-road"/><path d="M132 145 C234 102 330 122 424 86 C530 46 630 82 692 120" class="mc-stream"/><g class="mc-clocktowerCorrupted" transform="translate(302 118)"><rect x="44" y="116" width="92" height="152" rx="10" class="mc-towerBody"/><path d="M28 116 L90 58 L152 116 Z" class="mc-towerRoof"/><circle cx="90" cy="116" r="38" class="mc-clockFace"/><line x1="90" y1="116" x2="90" y2="88" class="mc-clockHandHour"/><line x1="90" y1="116" x2="64" y2="132" class="mc-clockHandMinute"/><rect x="70" y="204" width="40" height="64" rx="6" class="mc-door"/><text x="90" y="290" text-anchor="middle" class="mc-mapLabel">시계탑</text></g><g transform="translate(532 238)"><rect x="0" y="58" width="132" height="74" rx="16" class="mc-busBody"/><rect x="18" y="34" width="74" height="32" rx="8" class="mc-busSign"/><text x="55" y="56" text-anchor="middle" class="mc-busText">3:00</text><circle cx="34" cy="136" r="14" class="mc-wheel"/><circle cx="102" cy="136" r="14" class="mc-wheel"/><text x="66" y="172" text-anchor="middle" class="mc-mapLabel">숫자 버스</text></g></svg><div class="mc-placeButtons" aria-label="장소 목록"><button class="mc-placeButton mc-place-corrupted" type="button"><span class="mc-placeStatus">이상현상</span><strong>시계탑 광장</strong><small>시계탑이 멈춰 있어. 먼저 이곳을 조사하자.</small></button><button class="mc-placeButton mc-place-available" type="button"><span class="mc-placeStatus">잠김</span><strong>숫자 버스</strong><small>시계탑 단서를 얻으면 번호판을 조사할 수 있어.</small></button></div></div><aside class="mc-mapPanel" aria-label="현재 사건"><div class="mc-panelHeader"><span>현재 사건</span></div><h2>시계탑이 2시 40분에서 멈췄다</h2><p>버스는 3시에 출발해야 해. 현재 시각과 출발 시각을 같이 봐야 원인을 알 수 있어.</p><button class="mc-primaryAction" type="button">시계탑 조사하기</button></aside></div></section></main>`;
}
