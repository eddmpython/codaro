...
- normal `vX.Y.Z` tag release는 GitHub Release에 exact `codaro` wheel, `release-manifest.json`, `CodaroLauncher.exe`, checksum, SPDX SBOM, managed Windows Python runtime archive를 함께 업로드한다.
