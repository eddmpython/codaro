...
| `reference-products` | surface | 다섯 실제 Percent Python 제품의 compiler target, plain Python, static/server build와 serve, embed, Local Task artifact, desktop/mobile Chromium, 외부 요청, secret, 성능과 공개 claim 경계를 검증한다. |
