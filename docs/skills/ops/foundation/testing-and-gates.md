...
| `astryx-journey` | surface | Landing과 editor를 현재 source로 다시 build한 뒤 Landing·Learn catalog·public lesson·Web Run·Local 학습·자동화 대표 12개 case를 Dark·Light에서 각각 확인한다. |
