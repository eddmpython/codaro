...
- 에디터: 빈 노트북, Python/Markdown 셀, 셀 바로 아래 실행 결과, 우측 어시스턴트
- 커리큘럼: `curricula/` 레슨 트리, YAML에서 전개된 학습 셀, 셀 바로가기 TOC, 접을 수 있는 어시스턴트
...
- 셀 영역과 어시스턴트 사이에는 셀 바로가기 TOC를 둘 수 있다.
- 각 셀은 AI 호출을 직접 할 수 있어야 하고, 어시스턴트 패널은 접을 수 있어야 한다.
