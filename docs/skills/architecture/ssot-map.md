...
| product quality | `docs/skills/ops/product/service-candidate.md` | 잘 만들어진 로컬 제품인지 판단하는 내구성, 설치, runtime, provider, 성능 gate 기준 |
| diagnostic summary | `src/codaro/system/diagnosticSummary.py` | provider/runtime/package/frontend failure 분리와 secret redaction summary payload 기준 |
