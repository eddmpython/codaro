...
PyPI는 제품 launcher update에 필수 조건이 아니다. 필요해지는 시점은 developer install, third-party automation package 재사용, Python 생태계 검색/배포 채널을 열 때다.
...
- PyPI publish는 현재 product release의 필수 경로가 아니다. 필요해지면 별도 workflow로 분리한다
