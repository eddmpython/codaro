...
<h3 align="center">
  <img src="assets/brand/mascot/codaro-character.png" width="240" alt="Codaro 마스코트 - 웹 Python 학습과 로컬 자동화를 잇는 개인 스튜디오 캐릭터" /><br/>
  Codaro
</h3>
...
<p>
  <img alt="Web learning in a browser" src="https://img.shields.io/badge/Web-Learn_in_browser-0f766e?style=for-the-badge&labelColor=18181b" />
  <img alt="Local automation on Windows 10 and 11" src="https://img.shields.io/badge/Local-Windows_10%2F11-38bdf8?style=for-the-badge&labelColor=18181b&logo=windows&logoColor=white" />
...
<p>
  <a href="https://eddmpython.github.io/codaro/learn/"><img alt="웹에서 바로 학습" src="https://img.shields.io/badge/Web에서_바로_학습-Learn-0f766e?style=for-the-badge&labelColor=18181b" height="40" /></a>
  &nbsp;&nbsp;
  <a href="https://github.com/eddmpython/codaro/releases/latest/download/Codaro.exe"><img alt="Local 다운로드 - Codaro.exe" src="https://img.shields.io/badge/Local_다운로드-Codaro.exe-2563eb?style=for-the-badge&labelColor=18181b&logo=windows&logoColor=white" height="40" /></a>
</p>
...
<table>
  <tr>
    <td width="50%" align="center">
      <img src="assets/brand/visuals/product/web-run-desktop.png" alt="Codaro Web 학습 화면 - 커리큘럼 탐색, 코드 수정, 실행 결과와 자동 강검증 피드백" /><br/>
      <sub><strong>Web</strong> - 설치 없이 레슨을 읽고 코드를 수정하며 학습</sub>
    </td>
    <td width="50%" align="center">
      <img src="assets/brand/visuals/product/local-automation-desktop.png" alt="Codaro Local 자동화 화면 - 작업 상태, 최근 실행, 스케줄과 운영 제어" /><br/>
...
`examples/apps/`에는 다섯 reference product가 있습니다. 반응형 계산기, CSV 대시보드, snapshot 보고서, secret 참조 서버 앱, 로컬 파일 자동화를 각각 browser, server, local 경계로 실제 실행합니다.
