...
- 연결 이력이 없거나 끊긴 provider 복구 안내는 대화 surface에만 두고, backend offline처럼 노트북 실행·저장에 직접 영향을 주는 장애만 해당 작업 surface에 표시한다.
...
- 실행: `uv run python -X utf8 tests/run.py gate product-browser-webview2-evergreen`
