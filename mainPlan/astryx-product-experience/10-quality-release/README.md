...
| `product-browser-webview2-evergreen` | launcher/frontend | yes | Windows every change | current wheel과 실제 native WebView2의 Local 3개 viewport |
