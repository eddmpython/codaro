...
1. [앱 문서 계약](03-app-document-contract/README.md)
2. [앱 모드와 저작](04-app-mode-authoring/README.md)
3. [기능 블록 compiler](05-capability-compiler/README.md)
4. [정적 publication](06-static-publication/README.md)
5. [서버 publication](07-server-publication/README.md)
6. [블록 임베딩](08-block-embedding/README.md)
7. [학습과 제품 승격](09-learning-product-bridge/README.md)
8. [배포 adapter](10-deployment-adapters/README.md)
9. [참조 제품과 최종 claim](11-reference-products/README.md)
