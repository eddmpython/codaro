...
def _(mo):
    ...
    이 노트북은 `curricula/python/30days/day28_고급문법종합.yaml` YAML을 원본으로 생성했습니다. 위에서 아래로 읽고 실행하되, 연습 셀은 일부러 비워둔 공간입니다.
