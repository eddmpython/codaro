...
| Day | 이름 | 통과 기준 |
|---:|---|---|
| Day 05 | 문자열과 값 다루기 점검 | 이전 개념 3개 이상을 함께 써서 작은 만들기를 다시 구현한다. |
| Day 10 | 순서형/집합형 자료구조 점검 | 이전 개념 3개 이상을 함께 써서 작은 만들기를 다시 구현한다. |
| Day 15 | 조건, 반복, 함수 기초 점검 | 이전 개념 3개 이상을 함께 써서 작은 만들기를 다시 구현한다. |
| Day 20 | 모듈, 파일, 예외 처리 점검 | 이전 개념 3개 이상을 함께 써서 작은 만들기를 다시 구현한다. |
| Day 25 | 객체지향 기본 설계 점검 | 이전 개념 3개 이상을 함께 써서 작은 만들기를 다시 구현한다. |
| Day 30 | 최종 프로젝트 완성 점검 | 이전 개념 3개 이상을 함께 써서 작은 만들기를 다시 구현한다. |
...
- 핵심 개념: 코드 셀 실행, 따옴표로 감싼 글자, 숫자 계산, 결과 보기
...
- 핵심 개념: 값에 이름 붙이기, 정수와 소수, 글자 데이터, 참/거짓 값, 값의 종류 확인
...
- 핵심 개념: 숫자 계산, 나머지, 값 비교하기, 조건 묶기, 안에 있는지 확인하기
...
- 핵심 개념: 글자 이어 붙이기, f-string, 특수 문자 쓰기, 여러 줄 글자, 글자가 들어 있는지 확인하기
...
- 핵심 개념: 첫 번째 위치, 뒤에서 세는 위치, 일부분 잘라내기, 건너뛰며 잘라내기, 끝 번호는 포함하지 않는 규칙
