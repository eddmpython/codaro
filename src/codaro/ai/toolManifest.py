...
TOOL_METADATA: dict[str, ToolManifestMetadata] = {
    ...
    "open-automation-session": ToolManifestMetadata("automation", "automation", "browser-session", "external"),
    "run-automation-step": ToolManifestMetadata("automation", "automation", "browser-session", "input"),
    "query-automation-session": ToolManifestMetadata("automation", "read", "browser-session"),
    "list-automation-sessions": ToolManifestMetadata("automation", "read", "browser-session"),
    "close-automation-session": ToolManifestMetadata("automation", "automation", "browser-session"),
